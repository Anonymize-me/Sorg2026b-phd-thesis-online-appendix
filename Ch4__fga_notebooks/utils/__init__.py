...
__all__ = [
    ...
    'frange', 
    'list_bpmn_files', 'load_bpmn_file',
    'compute_grouped_stats', 'compute_grouped_mean', 'inferenceTest', 'inference_test',
    'read_imo_file_header',
    'modmax','lhipa', 'sliding_window_lhipa', 'batch_sliding_window_lhipa'
]
...
if __name__ == '__main__':
    ...
    from .bpmn_utils import list_bpmn_files, load_bpmn_file
    from .grouped_stats import compute_grouped_stats, compute_grouped_mean, inferenceTest, inference_test
