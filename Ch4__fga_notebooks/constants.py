...
# ORIG_DIR = r'C:\DEV\Data\Nassy\__tmp_exp3_2\data' # demo
ORIG_DIR = r'C:\DEV\Data\NASSY\Exp3\data\\' # Dir. with original raw data
ORIG_IMO_DIR = ORIG_DIR + r'Sensor Data\\'  # iMotions' raw data dir.
ORIG_EMI_DIR = ORIG_DIR + r'S\\'            # EyeMind's raw data dir.
DATA_DIR = r'data\\'                        # Output data dir.
...
PARTICIPANT_SETS = {
    ...
    'et-rejected': ['P19', 'P20'], # Calibration very poor (rejected)
    'et-accepted': ['P21', 'P23', 'P24', 'P25', 'P30'], # Calibration, minor problem (accepted)
    'set2': ['P01', 'P11'], # No affectiva /!\ USED in data preproc pipeline
    'set3': ['P13', 'P15', 'P25', 'P34'] # Not synched with EMi /!\ USED in data preproc pipeline
}
[PARTICIPANT_SETS['set1'].remove(x) for x in PARTICIPANT_SETS['et-rejected']]
#[PARTICIPANT_SETS['set1'].remove(x) for x in PARTICIPANT_SETS['et-accepted']]
